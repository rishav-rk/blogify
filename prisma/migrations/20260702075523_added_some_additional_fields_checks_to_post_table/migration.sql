...
INSERT INTO "new_Post" ("author", "content", "createdAt", "id", "isDeleted", "published", "slug", "title", "updatedAt") SELECT "author", "content", "createdAt", "id", "isDeleted", "published", "slug", "title", "updatedAt" FROM "Post";
DROP TABLE "Post";
